...
address = '.'
train_data = pd.read_csv(address + directory.persian_number_train_img_csv)
...
save_model_callback = SaveModelCallback(filepath=address + directory.hand_write_persian_number, val_loss=a[0], val_accuracy=a[1])
